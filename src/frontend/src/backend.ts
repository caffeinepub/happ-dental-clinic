...
export class Backend implements backendInterface {
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
    ...
    async getContactSubmissionById(arg0: bigint): Promise<ContactSubmission> {
        if (this.processError) {
            try {
